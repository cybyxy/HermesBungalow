...
from api.config import HOST, PORT, STATE_DIR, SESSION_DIR, DEFAULT_WORKSPACE, GATEWAY_MODE
...
def main() -> None:
    ...
    # Optional gateway watcher (disabled by default in this project)
    if GATEWAY_MODE:
        try:
        ...
        print('[ok] Gateway mode disabled.', flush=True)
