...
from backend.webui_api.auth import check_auth
from backend.webui_api.config import HOST, PORT, STATE_DIR, SESSION_DIR, DEFAULT_WORKSPACE
from backend.webui_api.helpers import j, get_profile_cookie
from backend.webui_api.profiles import set_request_profile, clear_request_profile
from backend.webui_api.routes import handle_get, handle_post
from backend.webui_api.startup import auto_install_agent_deps, fix_credential_permissions
from backend.webui_api.updates import WEBUI_VERSION
...
def main() -> None:
    from backend.webui_api.config import print_startup_config, verify_hermes_imports, _HERMES_FOUND
    ...
    from backend.webui_api.auth import is_auth_enabled
    ...
    try:
        from backend.webui_api.gateway_watcher import start_watcher
        start_watcher()
    except Exception as e:
    ...
    from backend.webui_api.config import TLS_ENABLED, TLS_CERT, TLS_KEY
    ...
    try:
        ...
        try:
            from backend.webui_api.gateway_watcher import stop_watcher
            stop_watcher()
        except Exception:
