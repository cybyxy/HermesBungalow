...
def _get_ai_agent():
    ...
    if AIAgent is None:
        try:
            ...
            pass
    return AIAgent
from .models import get_session, title_from
from .workspace import set_last_workspace
...
def _run_agent_streaming(session_id, msg_text, model, workspace, stream_id, attachments=None, *, ephemeral=False):
    ...
    try:
        ...
        try:
            from .profiles import get_hermes_home_for_profile
        ...
        def _clarify_callback_impl(question, choices, sid, cancel_evt, put_event):
            ...
            try:
                from .clarify import submit_pending as _submit_clarify_pending, clear_pending as _clear_clarify_pending
            except ImportError:
                return (
        ...
        try:
            ...
            from .config import _resolve_cli_toolsets
            ...
            try:
                from .config import parse_reasoning_effort as _parse_reff
            ...
            if ephemeral:
                ...
                from .config import SESSION_AGENT_CACHE, SESSION_AGENT_CACHE_LOCK
...
def cancel_stream(stream_id: str) -> bool:
    ...
    with STREAMS_LOCK:
        ...
        try:
            from .clarify import clear_pending as _clear_clarify_pending
